...
@Component({
  ...
  `,
  styles: [`.code-samples-page { h1 { font-size: 3rem; margin-bottom: 1rem; } .lead { font-size: 1.25rem; margin-bottom: 3rem; color: var(--text-color-secondary); } pre { background: var(--surface-900); color: #e5e7eb; padding: 1.5rem; border-radius: 8px; overflow-x: auto; } }`]
})
