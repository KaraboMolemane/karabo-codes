...
export const appRoutes: Route[] = [
    ...
    //     loadComponent: () => import('./projects/components/components').then(m => m.Components),
    // },
    // {
    //     path: 'projects/blocks',
    //     loadComponent: () => import('./projects/blocks/blocks').then(m => m.Blocks),
    // },
    // {
    //     path: 'projects/ui-kit',
    //     loadComponent: () => import('./projects/ui-kit/ui-kit').then(m => m.UiKit),
    // },
    // {
    ...
    // {
    //     path: 'system-design',
    //     loadComponent: () => import('./system-design/system-design').then(m => m.SystemDesign),
    // },
    // {
    //     path: 'code-quality',
    //     loadComponent: () => import('./code-quality/code-quality').then(m => m.CodeQuality),
    // },
    {
        path: 'resume',
